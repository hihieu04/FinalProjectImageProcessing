...
def tesseract_ocr(img):
    ...
    # ...
    pytesseract.pytesseract.tesseract_cmd = r'utility/B10_RecognitionLicensePlates/Tesseract-OCR/tesseract.exe'
...
def main():
    ...
    pre_trained_model = "utility/B10_RecognitionLicensePlates/best.pt"
